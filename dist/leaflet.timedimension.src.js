(() => {
  ...
  // ../../node_modules/.pnpm/iso8601-js-period@0.2.1/node_modules/iso8601-js-period/iso8601.js
  var require_iso8601 = __commonJS({
    "../../node_modules/.pnpm/iso8601-js-period@0.2.1/node_modules/iso8601-js-period/iso8601.js"(exports, module) {
      (function(root, factory) {
        if (typeof define === "function" && define.amd) {
          ...
          if (!root.nezasa)
            root.nezasa = {};
          if (!root.nezasa.iso8601)
            root.nezasa.iso8601 = factory();
        }
      })(exports, function() {
        var iso86012 = {
          Period: {}
        };
        iso86012.version = "0.2";
        iso86012.Period.parse = function(period, distributeOverflow) {
          return parsePeriodString(period, distributeOverflow);
        };
        iso86012.Period.parseToTotalSeconds = function(period) {
          var multiplicators = [
            31104e3,
            2592e3,
            604800,
        ...
        iso86012.Period.isValid = function(period) {
          try {
        ...
        iso86012.Period.parseToString = function(period, unitNames, unitNamesPlural, distributeOverflow) {
          var result = ["", "", "", "", "", "", ""];
          var durationPerUnit = parsePeriodString(period, distributeOverflow);
          if (!unitNames)
            unitNames = ["year", "month", "week", "day", "hour", "minute", "second"];
          if (!unitNamesPlural)
            unitNamesPlural = ["years", "months", "weeks", "days", "hours", "minutes", "seconds"];
          for (var i = 0; i < durationPerUnit.length; i++) {
  ...
  var require_leaflet_timedimension = __commonJS({
    "src/leaflet.timedimension.js"() {
      L.TimeDimension = (L.Layer || L.Class).extend({
        ...
        _getDefaultCurrentTime: function() {
          var index = this._seekNearestTimeIndex((/* @__PURE__ */ new Date()).getTime());
          return this._availableTimes[index];
        },
  ...
  var require_leaflet_timedimension_util = __commonJS({
    "src/leaflet.timedimension.util.js"() {
  ...
  var require_leaflet_timedimension_layer = __commonJS({
    "src/leaflet.timedimension.layer.js"() {
  ...
  var require_leaflet_timedimension_layer_wms = __commonJS({
    "src/leaflet.timedimension.layer.wms.js"() {
  ...
  var require_leaflet_timedimension_layer_geojson = __commonJS({
    "src/leaflet.timedimension.layer.geojson.js"() {
  ...
  var require_leaflet_timedimension_player = __commonJS({
    "src/leaflet.timedimension.player.js"() {
  ...
  var require_leaflet_timedimension_control = __commonJS({
    "src/leaflet.timedimension.control.js"() {
      L.UI = L.ui = L.UI || {};
      ...
      L.Control.TimeDimension = L.Control.extend({
        ...
        _createButton: function(title, container) {
          ...
          link.href = "#";
          link.title = title;
          L.DomEvent.addListener(link, "click", L.DomEvent.stopPropagation).addListener(link, "click", L.DomEvent.preventDefault).addListener(link, "click", this["_button" + title.replace(/ /i, "") + "Clicked"], this);
          return link;
        },
        _createSliderTime: function(className, container) {
          ...
          L.DomEvent.on(sliderbar, "click", function(e) {
            ...
            var first = e.touches && e.touches.length === 1 ? e.touches[0] : e, x = L.DomEvent.getMousePosition(first, sliderbar).x;
            if (limits) {
  ...
  // src/index.js
  var iso8601 = require_iso8601();
  if (typeof window !== "undefined" && window.L && typeof L !== "undefined") {
    window.nezasa = { iso8601 };
  }
  require_leaflet_timedimension();
  require_leaflet_timedimension_util();
  require_leaflet_timedimension_layer();
  require_leaflet_timedimension_layer_wms();
  require_leaflet_timedimension_layer_geojson();
  require_leaflet_timedimension_player();
  require_leaflet_timedimension_control();
})();
//# sourceMappingURL=leaflet.timedimension.src.js.map
